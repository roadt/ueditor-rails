...
(function () {
    ...
    URL = "/assets/ueditor/";;   //window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/ueditor/images/upload.json"             //图片上传提交地址
      ...
      // ,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //附件上传配置区
        ,fileUrl:"/ueditor/attachments.json"               //附件上传提交地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:"/ueditor/images/manage.json"       //图片在线管理的处理地址
...
//["fontfamily","fontsize","undo","redo","insertorderedlist","insertimage","emotion","insertvideo","preview"]
        ]
